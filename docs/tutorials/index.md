...
```{todo}
Currently there are few official tutorials for Torii, however due to it being a fork of [Amaranth](https://github.com/amaranth-lang/amaranth) the following tutorials written by the Amaranth community are a good place to start.
