...
class Value(metaclass = ABCMeta):
	...
	def shr(self, amount: int, *, src_loc_at: int = 0) -> Assign:
		'''
		In-place Value right shift.

		This is shorthand for the following Torii statement:
		.. code-block: python

			a.eq(a.shift_right(amount))
		...
		return Assign(self, self.shift_right(amount, src_loc_at = 1 + src_loc_at), src_loc_at = 1 + src_loc_at)

	def rol(self, amount: int, *, src_loc_at: int = 0) -> Assign:
		'''
		In-place Value rotate left.

		This is shorthand for the following Torii statement:
		.. code-block: python

			a.eq(a.rotate_left(amount))
		...
		return Assign(self, self.rotate_left(amount, src_loc_at = 1 + src_loc_at), src_loc_at = 1 + src_loc_at)

	def ror(self, amount: int, *, src_loc_at: int = 0) -> Assign:
		'''
		In-place Value rotate right.

		This is shorthand for the following Torii statement:
		.. code-block: python

			a.eq(a.rotate_right(amount))
		...
		return Assign(self, self.rotate_right(amount, src_loc_at = 1 + src_loc_at), src_loc_at = 1 + src_loc_at)
